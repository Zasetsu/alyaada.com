...
<head>
		...
		<title><?=$lang['Services'];?> | Ada Alya</title>
					...
					<div class="container container-xl-custom">
						<div class="row">
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								<h1 class="text-dark font-weight-bold"><?=$lang['Services'];?></h1>
							</div>
				...
				<div class="container container-xl-custom pt-5 pb-3 mt-4">
					<div class="row">
						...
						<div class="col-lg-3 mb-5">
							...
							<h4 class="font-weight-bold mt-4">Fason Enjeksiyon Baskı</h4>
						...
						<div class="col-lg-3 mb-5">
							...
							<h4 class="font-weight-bold mt-4">Talaşlı İmalat</h4>
							<ul class="list list-icons list-primary font-weight-medium mt-3">
						...
						<div class="col-lg-3 mb-5">
							...
							<h4 class="font-weight-bold mt-4">Plastik Kalıp</h4>
							<ul class="list list-icons list-primary font-weight-medium mt-3">
						...
						<div class="col-lg-3 mb-5">
							...
							<h4 class="font-weight-bold mt-4">Kalıp Bakım Revizyon</h4>
							<ul class="list list-icons list-primary font-weight-medium mt-3">
...
Devamlı iyileştirme ve geliştirmeyi ön planda tutan işletmemiz geleceğe emin adımlarla yürümek istemektedir.
							...
							<div class="col-lg-3 mt-3 mt-lg-0 text-lg-end">
								<a href="<?=$lang['QuoteLink']?>" class="btn btn-modern btn-light text-color-dark font-weight-bold border-0 py-3 px-5 btn-arrow-effect-1 ws-nowrap">Teklif Al <i class="fas fa-arrow-right ms-2"></i></a>
							</div>
						</div>
					</div>
				</section>
