...
<head>
    ...
    <title><?= $lang['Contact']; ?> | Ada Alya</title>
    <meta name="description"
        content="Firmamız, 2014 yılında sanayi tipi elektrik Sintaş fiş ve prizleri üretimi konusunda uzmanlaşmak amacıyla kurulmuştur. 16 amperden 100 ampere kadar geniş bir ürün yelpazesiyle sektörde fark yaratan firmamız, müşteri memnuniyetini ve kaliteyi daima ön planda tutarak, hızlı ve güvenilir çözümler sunmaktadır.">
    ...
    <div class="body">
        ...
        <div role="main" class="main">
                ...
                <div class="container container-xl-custom">
                    <div class="row">
                        <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                            <h1 class="text-dark font-weight-bold"><?= $lang['Contact']; ?></h1>
                        </div>
            ...
            <section class="section my-0 py-5 border-0 bg-color-tertiary text-color-light p-relative overflow-hidden">
                ...
                <svg class="d-none d-lg-block custom-svg-position-3 rotate-r-90" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 1686.88 1095.86" data-appear-animation-svg="true">
                    <path class="appear-animation" data-plugin-options="{'accY': -500, 'forceAnimation': true}"
                        data-appear-animation="customLines1anim" data-appear-animation-delay="100"
                ...
                <div class="container container-xl-custom">
                    <div class="row mt-5 pt-3 justify-content-between">
                        <div class="col-lg-5 text-color-light">
                            <h4 class="text-primary text-3 font-weight-bold mb-2">Ada Alya</h4>
                            <h3 class="mb-3 text-color-light">Bize ulaşın.<br>
                            </h3>
                            <p class="mb-4 pb-2 text-color-light opacity-7">
								İlgili ürün veya hizmetler hakkında detaylı bilgi almak ve ihtiyaçlarınıza en uygun
								çözümü belirlemek için yan taraftaki formu doldurabilirsiniz. Talebinize dair teknik
								dokümanlar, 3 boyutlu tasarımlar ve benzeri belgeleri form üzerinden ekleyerek süreci
								hızlandırabilirsiniz.
								<br>
								<br>
								Sorularınız ve talepleriniz için her zaman yanınızdayız. Sizlere en iyi hizmeti
								sunmaktan memnuniyet duyarız.
							</p>

                            <div class="d-block pb-4">
                                <p class="text-uppercase text-2 font-weight-bold mb-0 text-color-light opacity-7">Telefon</p>
                                <a href="tel:02645980698"
                                    class="d-flex align-items-center text-decoration-none text-color-light text-color-hover-light font-weight-medium ms-1">
                            ...
                            <div class="d-block pb-4">
                                <p class="text-uppercase text-2 font-weight-bold mb-0 text-color-light opacity-7">GSM</p>
                                <a href="tel:05327802622"
                                    class="d-flex align-items-center text-decoration-none text-color-light text-color-hover-light font-weight-medium ms-1">
                                    <i class="icon icon-phone text-color-light text-4-5 me-2"></i>
                                    +90 532 780 26 22
                                </a>
                            ...
                            <div class="d-block pb-4">
                                <p class="text-uppercase text-2 font-weight-bold mb-0 text-color-light opacity-7">E-Posta</p>
                                <p class="p-relative bottom-4 text-color-light">
                                    <a class="text-2 font-weight-bold mb-0 text-color-light"
                                        href="malto:info@adaalya.com">
                                        info@adaalya.com
                                    </a>
                            ...
                            <div class="d-block pb-4">
                                <p class="text-uppercase text-2 font-weight-bold mb-0 text-color-light opacity-7">
                                    Adres</p>
                                <p class="p-relative bottom-4 text-color-light">
                                ALYA Plastik ve Elektrik Malzemeleri Tic. ve San. Ltd. Şti.
                                <br>
                                Erenler Mahallesi Sakarya Sanayi Sitesi 1266. Sokak No: 14 Postakodu 54200 Erenler / Sakarya / TÜRKİYE
                                </p>
                            </div>

                            <div class="d-block pb-4">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3023.041983594576!2d30.407440499999996!3d40.739101700000006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14ccb3bb605585c1%3A0xa2646e71bf2b1c7!2sAlya%20Plastik%20ve%20Elektrik%20Malzemeleri%20Tic.%20San.%20Ltd.%20%C5%9Eti.!5e0!3m2!1str!2str!4v1726051682739!5m2!1str!2str" width="100%" height="260" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-5 mt-lg-0">
                            <h2 class="text-color-light font-weight-bold text-10 negative-ls-05 line-height-1 mb-5">
                                Teklif ve<span
                                    class="font-weight-extra-bold custom-highlight-1 ws-nowrap p-1 custom-highlight-anim custom-highlight-anim-delay">İletişim</span> Formu
                            </h2>

                            <div class="card border-0 bg-color-light text-color-tertiary">
                                <div class="card-body m-4">
									<p class="mb-4">Bize ulaşmak veya teklif almak için aşağıdaki formu
										doldurabilirsiniz.</p>
										<?php
									...
									<form 
										...
										<div class="row">
											<div class="form-group col-lg-12">
												<label
													class="form-label mb-1 text-2 text-color-dark font-weight-semibold">Ad
													& Soyad</label>
												<input type="text" value="umut" data-msg-required="Lütfen ad&soyad girin."
													class="form-control text-3 h-auto py-2" name="name" required>
											</div>
											<div class="form-group col-lg-6">
												<label
													class="form-label mb-1 text-2 text-color-dark font-weight-semibold">E-Posta
													Adresi</label>
												<input type="email" value="umut@test.com"
											...
											<div class="form-group col-lg-6">
												<label
													class="form-label mb-1 text-2 text-color-dark font-weight-semibold">Telefon</label>
												<input type="text" class="form-control text-3 h-auto py-2" value="05414990031"
													data-msg-required="Lütfen telefonunuzu girin" name="phone" required>
											</div>
										</div>
										...
										<div class="row">
											<div class="form-group col">
												<label
													class="form-label mb-1 text-2 text-color-dark font-weight-semibold">Mesajınız</label>
													<textarea class="form-control" name="message" rows="3" id="textareaDefault">test</textarea>
											</div>
										</div>
										...
										<div class="row">
											<div class="form-group col">
												<label
													class="form-label mb-1 text-2 text-color-dark font-weight-semibold">Dosya</label>
												<input type="file" multiple class="form-control text-3 h-auto py-2"
													value="" name="files[]">
											</div>
										</div>
										...
										<div class="row pt-2">
											<div class="form-group col">
												<input type="submit" value="Gönder" name="submit"
													class="btn btn-modern btn-primary font-weight-bold border-0 py-3 px-5"
