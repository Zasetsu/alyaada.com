								...
								<div class="header-column">
									<div class="header-row">
										<div class="header-logo m-0">
											<a href="/">
												<img alt="Ada Alya" src="img/logoalya.jpg" class="headerLogo">
											</a>
										</div>
									</div>
								</div>
										...
										<div class="d-none d-lg-inline-block">
											<ul class="nav nav-pills me-1">
												<li class="nav-item pe-2 mx-1">
													<a href="https://www.facebook.com/people/ALYA-Plastic-Electric/100069836910893/" target="_blank" title="Facebook" class="text-color-dark text-color-hover-primary text-2"><i class="fab fa-facebook-f"></i></a>
												</li>
												<li class="nav-item px-2 mx-1">
													<a href="https://x.com/264ALYA" target="_blank" title="X" class="text-color-dark text-color-hover-primary text-2"><i class="fab fa-x-twitter"></i></a>
												</li>
												<li class="nav-item px-2 mx-1">
													<a href="https://www.instagram.com/264alya/" target="_blank" title="Instagram" class="text-color-dark text-color-hover-primary text-2"><i class="fab fa-instagram"></i></a>
												</li>
											</ul>
										</div>
										<div class="vr opacity-2 d-none d-lg-inline-block"></div>
							...
							<div class="header-row py-2">
								<div class="header-column">
									<div class="header-row align-items-center justify-content-end">
										...
										<a href="<?= $lang['QuoteLink'] ?>" class="btn btn-modern btn-primary font-weight-bold border-0 btn-arrow-effect-1">
                                            <?= $lang['Get a Quote'] ?>
