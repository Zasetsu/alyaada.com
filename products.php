...
?>
<!DOCTYPE html>
<html lang="en" data-style-switcher-options="{'showBordersStyle': true, 'showLayoutStyle': false, 'showBackgroundColor': false, 'fontFamily': 'Jost', 'colorPrimary': '#00a335', 'colorSecondary': '#088d33', 'colorTertiary': '#5f6c77', 'colorQuaternary': '#272e32'}">
<head>
		...
		<div class="body">
			...
			<section class="page-header page-header-modern bg-color-grey page-header-lg m-0">
					<div class="container container-xl-custom">
						<div class="row">
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								<h1 class="text-dark font-weight-bold"><?=$lang['Products'];?></h1>
							</div>
				...
				<div class="container container-xl-custom pt-5 pb-3 mt-4">
					...
					<div class="row">
						<div class="col-lg-3">
							<div class="card border-0 bg-color-light box-shadow-2 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
								<div class="card-body text-center text-lg-start m-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="100" data-plugin-options="{'minWindowWidth': 0}">
									<img height="90" src="img/pr1.jpg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-stroke-color-primary mb-4'}"  style="margin: auto;display:block"/>
                                    <br>
									<h4 class="font-weight-bold mt-4 text-center">4 Kutuplu Trifaze Fiş Priz (Sıva Üstü)</h4>
									<p class="text-3" style="font-weight: 300">
                                        M4000EC1016025 16/25A 380V <br>
M4000EC1025040 25/40A 380V <br>
M4000EC1040063 40/63A 380V <br>
M4000EC1063100 63/100A 500V
                                    </p>
									<a href="#" class="btn btn-arrow-effect-1 ws-nowrap text-primary text-2 bg-transparent border-0 px-0 text-uppercase"><?=$lang['Get a Quote']?> <i class="fas fa-arrow-right ms-2"></i></a>
								</div>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="card border-0 bg-color-light box-shadow-2 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
								<div class="card-body text-center text-lg-start m-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="400" data-plugin-options="{'minWindowWidth': 0}">
									<img height="90" src="img/pr2.jpg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-stroke-color-primary mb-4'}"  style="margin: auto;display:block" />
									<h4 class="font-weight-bold mt-4 text-center">4 Kutuplu Trifaze Fiş</h4>
                                    <br>
                                    <br>
									<p class="text-3" style="font-weight: 300">
                                        M4000EA1016025 16/25A 380V<br>
M4000EA1025040 25/40A 380V<br>
M4000EA1040063 40/63A 380V<br>
M4000EA1063100 63/100A 500V
                                    </p>
									<a href="#" class="btn btn-arrow-effect-1 ws-nowrap text-primary text-2 bg-transparent border-0 px-0 text-uppercase"><?=$lang['Get a Quote']?> <i class="fas fa-arrow-right ms-2"></i></a>
								</div>
							</div>
						...
						<div class="col-lg-3">
							<div class="card border-0 bg-color-light box-shadow-2 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
								<div class="card-body text-center text-lg-start m-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="700" data-plugin-options="{'minWindowWidth': 0}">
									<img height="90" src="img/pr3.jpg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-stroke-color-primary mb-4'}" style="margin: auto;display: block" />
									<h4 class="font-weight-bold mt-4 text-center">4 Kutuplu Trifaze Priz <br>(Sıva Üstü)</h4>
                                    <br>
									<p class="text-3" style="font-weight: 300">
                                        M4000EB1016025 16/25A 380V<br>
M4000EB1025040 25/40A 380V<br>
M4000EB1040063 40/63A 380V<br>
M4000EB1063100 63/100A 500V
                                    </p>
									<a href="#" class="btn btn-arrow-effect-1 ws-nowrap text-primary text-2 bg-transparent border-0 px-0 text-uppercase"><?=$lang['Get a Quote']?> <i class="fas fa-arrow-right ms-2"></i></a>
								</div>
							</div>
						...
						<div class="col-lg-3">
							<div class="card border-0 bg-color-light box-shadow-2 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
								<div class="card-body text-center text-lg-start m-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="1200" data-plugin-options="{'minWindowWidth': 0}">
									<img height="90" src="img/pr4.jpg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-stroke-color-primary mb-4'}" style="margin: auto;display: block" />
									<h4 class="font-weight-bold mt-4 text-center">
                                        4 Kutuplu Trifaze Priz <br>(Seyyar)
                                    </h4>
                                    <br>
									<p class="text-3" style="font-weight: 300">
                                        M4000EA2016025 16/25A 380V<br>
M4000EA2025040 25/40A 380V<br>
M4000EA2040063 40/63A 380V<br>
M4000EA2063100 63/100A 500V
                                    </p>
									<a href="#" class="btn btn-arrow-effect-1 ws-nowrap text-primary text-2 bg-transparent border-0 px-0 text-uppercase"><?=$lang['Get a Quote']?> <i class="fas fa-arrow-right ms-2"></i></a>
								</div>
							</div>
				...
				<section class="section my-0 border-0 bg-color-primary text-color-light p-relative overflow-hidden">
					...
					<div class="container container-xl-custom pt-4 ">
						<div class="row align-items-center py-5">
							<div class="col-lg-3 text-lg-end">
								<h2 class="text-color-light font-weight-bold text-10 negative-ls-05 line-height-1 mb-0 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="100" data-plugin-options="{'minWindowWidth': 0}">Ürünler<br><span class="font-weight-extra-bold custom-highlight-1 custom-highlight-1-tertiary ws-nowrap p-1 custom-highlight-anim custom-highlight-anim-delay">ve Hizmetler</span></h2>
							</div>
							<div class="col-lg-6 mt-3 mt-lg-0">
								<p class="mb-0 text-color-light ps-lg-5">
Devamlı iyileştirme ve geliştirmeyi ön planda tutan işletmemiz geleceğe emin adımlarla yürümek istemektedir.
                                </p>
							</div>
							<div class="col-lg-3 mt-3 mt-lg-0 text-lg-end">
								<a href="#" class="btn btn-modern btn-light text-color-dark font-weight-bold border-0 py-3 px-5 btn-arrow-effect-1 ws-nowrap">Teklif Al <i class="fas fa-arrow-right ms-2"></i></a>
							</div>
						</div>
					</div>
				</section>
